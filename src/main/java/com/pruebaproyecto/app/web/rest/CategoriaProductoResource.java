...
import com.pruebaproyecto.app.service.CategoriaProductoService;
...
/**
 * REST controller for managing {@link com.pruebaproyecto.app.domain.CategoriaProducto}.
 */
@RestController
@RequestMapping("/api")
public class CategoriaProductoResource {
    ...
    public ResponseEntity<CategoriaProductoDTO> updateCategoriaProducto(
        ...
        CategoriaProductoDTO result = categoriaProductoService.update(categoriaProductoDTO);
        return ResponseEntity
            .ok()
