...
export class PromocionService {
  ...
  protected convertDateFromClient(promocion: IPromocion): IPromocion {
    return Object.assign({}, promocion, {
      fechaInicio: promocion.fechaInicio?.isValid() ? promocion.fechaInicio.toJSON() : undefined,
      fechaFin: promocion.fechaFin?.isValid() ? promocion.fechaFin.toJSON() : undefined,
    });
  }
