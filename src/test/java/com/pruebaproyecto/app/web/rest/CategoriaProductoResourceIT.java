...
import com.pruebaproyecto.app.repository.CategoriaProductoRepository;
import com.pruebaproyecto.app.service.dto.CategoriaProductoDTO;
import com.pruebaproyecto.app.service.mapper.CategoriaProductoMapper;
...
class CategoriaProductoResourceIT {
    ...
    public static CategoriaProducto createEntity(EntityManager em) {
        CategoriaProducto categoriaProducto = new CategoriaProducto().nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION);
    ...
    public static CategoriaProducto createUpdatedEntity(EntityManager em) {
        CategoriaProducto categoriaProducto = new CategoriaProducto().nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
        return categoriaProducto;
    }
